            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {pets.map((pet) => (
                <Link
                  key={pet.id}
                  href={`/pets/${pet.id}`}
                  className="group flex min-h-72 flex-col rounded-3xl border border-zinc-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-amber-300 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-amber-700/60"
                >
                  <div className="flex items-start gap-4">
                    <span
                      className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-linear-to-br from-amber-100 to-rose-100 text-5xl shadow-inner dark:from-amber-950/50 dark:to-rose-950/40"
                      aria-hidden
                    >
                      {pet.avatar_emoji}
                    </span>
                  ...
                  <span className="mt-5 inline-flex items-center justify-center rounded-xl bg-zinc-900 px-4 py-2 text-sm font-semibold text-white transition group-hover:bg-amber-500 dark:bg-zinc-100 dark:text-zinc-900 dark:group-hover:bg-amber-400">
